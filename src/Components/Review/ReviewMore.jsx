  ...
  return (
    <div className='pt-20 bg-blue-950'>
        <div data-aos="fade-up"
                        ...
                        className='grid md:grid-cols-2 lg:grid-cols-3 gap-3 mx-4'>
        
                        <div className=' py-10 rounded-2xl border-t-8 border-b-8 border-blue-700 bg-fuchsia-100 text-center justify-center transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className=' p-5 rounded-2xl border-t-8 border-b-8 border-blue-700 bg-purple-100 text-center justify-center transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className=' p-5 rounded-2xl border-t-8 border-b-8 border-blue-700 bg-pink-100 text-center justify-center transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className=' p-5 rounded-2xl border-t-8 border-b-8 border-blue-700 bg-rose-100 text-center justify-center transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className=' p-5 rounded-2xl border-t-8 border-b-8 border-blue-700 bg-amber-100 text-center justify-center transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className=' p-5 rounded-2xl border-t-8 border-b-8 border-blue-700 bg-green-100 text-center justify-center transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className=' p-5 rounded-2xl border-t-8 border-b-8 border-blue-700 bg-lime-100 text-center justify-center transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110'>
